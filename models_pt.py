...
def get_model(model_name):
    if model_name == "deeplob":
        return DeepLOB  # Return the class itself, not an instance
    elif model_name == "deeplob2":
        return DeepLOB2
    elif model_name == "deeplob3":
        return DeepLOB3
    elif model_name == "deeplob4":
        return DeepLOB4
    elif model_name == "deeplob5":
        return DeepLOB5
    elif model_name == "deeplob6":
        return DeepLOB6
    elif model_name == "transformer":
        return Transformer
    elif model_name == "transformer2":
        return Transformer2
    elif model_name == "transformer3":
        return Transformer3
    elif model_name == "transformer4":
        return Transformer4
    elif model_name == "transformer5":
        return Transformer5
    elif model_name == "transformer6":
        return Transformer6
    elif model_name == "lobtransformer":
        return LOBTransformer
    elif model_name == "lobtransformer2":
        return LOBTransformer2
...
class DeepLOB2(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.name = "deeplob2"
        ...
        self.inp4 = nn.Sequential(
            nn.MaxPool2d((5, 1), stride=(1, 1), padding=(2,0)),  # (None, 100, 1, 32)
            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(1, 1), padding="same"),  # (None, 100, 1, 64)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(64),
        )
        self.inp5 = nn.Sequential(
            nn.MaxPool2d((7, 1), stride=(1, 1), padding=(3,0)),  # (None, 100, 1, 32)
            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(1, 1), padding="same"),  # (None, 100, 1, 64)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(64),
        )
        ...
        # LSTM layers.
        self.lstm = nn.LSTM(input_size=320, hidden_size=64, num_layers=1, batch_first=True)  # (None, 64)
        self.fc1 = nn.Linear(64, 3)
...
class DeepLOB3(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.name = "deeplob3"
        ...
        # Convolution blocks.
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(1, 2), stride=(1, 2)),  # (None, 100, 40, 1) -> (None, 100, 20, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(4, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(4, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.MaxPool2d(kernel_size=(1, 20))
        )

        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(1, 4), stride=(1, 4)),  # (None, 100, 40, 1) -> (None, 100, 20, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(4, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(1, 8), stride=(1, 8)),  # (None, 100, 40, 1) -> (None, 100, 20, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(4, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
        ...
        self.conv4 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(1, 16), stride=(1, 16)),  # (None, 100, 40, 1) -> (None, 100, 20, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(4, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
...
class DeepLOB4(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.name = "deeplob4"
        ...
        self.conv1 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(2, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(2, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
        ...
        self.conv3 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(8, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(8, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
        ...
        self.conv4 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(16, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(16, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
...
class DeepLOB5(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.name = "deeplob5"
        ...
        self.conv1 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(1, 20)),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8)
        )
        ...
        self.conv2 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(1, 10)),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8)
        )
        ...
        self.conv3 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(1, 5)),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8)
        )
        ...
        self.conv4 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8),
            nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(1, 2)),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(8)
        )
...
class DeepLOB6(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.name = "deeplob6"
        ...
        self.conv1 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(32),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(10, 1), padding='same'),  # (None, 100, 20, 32) -> (None, 100, 20, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(32),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(10, 1), padding='same'),  # (None, 100, 20, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(32),
        )
        ...
        self.conv2 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(32),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(10, 1), padding='same'),  # (None, 100, 10, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(32),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(10, 1), padding='same'),  # (None, 100, 10, 32)
            nn.LeakyReLU(negative_slope=0.01),
        ...
        self.conv3 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(32),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(10, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(32),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(10, 1), padding='same'),  # (None, 100, 1, 32)
            nn.LeakyReLU(negative_slope=0.01),
        ...
        self.inp2 = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(64),
            nn.Conv2d(in_channels=64, out_channels=64, kernel_size=(15, 1), padding="same"),  # (None, 100, 1, 64)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(64),
        )
        self.inp3 = nn.Sequential(
            nn.MaxPool2d((5, 1), stride=(1, 1), padding=(1,0)),  # (None, 100, 1, 32)
            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(1, 1), padding="same"),  # (None, 100, 1, 64)
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm2d(64),
        )
...
class LOBTransformer2(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.name = "lobtransformer2"
...
# x2 nhead     
class Transformer3(pl.LightningModule):
    def __init__(
        self,
        dropout: float = 0.1,
        activation: str = "relu",
...
# x2 d_model
class Transformer5(pl.LightningModule):
    def __init__(
        self,
        dropout: float = 0.1,
        activation: str = "relu",
...
class Transformer6(pl.LightningModule):
    def __init__(
        self,
        dropout: float = 0.1,
        activation: str = "relu",
...
class TABL_layer(pl.LightningModule):
    ...
    def forward(self, X):
        ...
        # applying a soft attention mechanism (equation 10) over hard, otherwise hard attention can in early stages of the training 
        # select noisy information appearing to be most important ones  
